...
hparams = {
    "dataset_names": tune.grid_search(
        [
            ...
            ["train_5_20_test_31_40"],
            ["train_5_20_test_51_60"],
            ["train_5_20_test_71_80"],
            ["train_5_20_test_91_100"],
            ["train_5_10_test_31_40"],
            ["train_5_10_test_51_60"],
            ["train_5_10_test_71_80"],
            ["train_5_10_test_91_100"],
            ["train_5_20_test_11_20"],
...
class Trainable(tune.Trainable):
    def setup(self, config):
        ...
        full_config[
            "results_folder"
        ] = "/export/scratch1/home/arkadiy/CombineGNN/results/final_CombineGNN4"
        full_config[
            "out_name_template"
        ...
        self.config_path = os.path.join(
            "/export/scratch1/home/arkadiy/CombineGNN/configs/CombineGNN",
            str(trial_num) + ".yaml",
        )
